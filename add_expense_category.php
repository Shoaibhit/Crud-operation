...
// Optional: check for duplicates (case-insensitive, trimmed)
$checkSql = "SELECT id, name FROM expense_categories WHERE LOWER(TRIM(name)) = LOWER(TRIM(?)) LIMIT 1";
...
$insertSql = "INSERT INTO expense_categories (name) VALUES (?)";
