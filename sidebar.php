<aside class="col-12 col-md-3 col-xl-2 sidebar p-4 position-relative">
    <div class="mb-5">
        <h2 class="brand text-white fw-bold mb-1">Dashboard</h2>
        <p class="text-muted small mb-0">Dashboard</p>
    </div>
    <nav class="nav flex-column gap-2">
        <a href="charts_of_accounts.php" class="nav-link d-flex align-items-center"><i class="bi bi-credit-card me-2"></i>Charts of Accounts</a>
        <a href="income_form.php" class="nav-link d-flex align-items-center"><i class="bi bi-wallet me-2"></i>Income</a>
        <a href="expence_form.php" class="nav-link d-flex align-items-center"><i class="bi bi-wallet2 me-2"></i>Expenses</a>
